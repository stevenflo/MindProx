...
#if defined(SPEC)
	int obj_type = 0;			/* object type, on 2 bits */
#else
...
;
#if defined(SPEC)
        /* Make GCC shut up about uninitialized use, and keep from maybe
         * dumping garbage on the stack
         */
